            ...
            <form onSubmit={handleSubmit} className="mb-10">
              ...
              {submitted && (
                <div className="mt-6 p-4 bg-green-50 border border-green-100 rounded-2xl animate-reveal">
                  ...
                  <a 
                    href="https://chat.whatsapp.com/DnWyjWmrh5jGKJY9K949pW" 
                    target="_blank" 
      ...
      <footer className="border-t border-gray-200 mt-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center text-gray-600">
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <a href="https://chat.whatsapp.com/DnWyjWmrh5jGKJY9K949pW" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-gray-500 hover:text-[#25D366] transition-colors">
      ...
      {showComingSoon && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-2xl p-8 max-w-sm w-full text-center shadow-xl relative animate-in fade-in zoom-in duration-200 z-10">
            ...
            <p className="text-gray-600 mb-6">We're working hard to get this feature ready for you. Subscribe to get notified!</p>
            
            <form onSubmit={(e) => {
              handleSubmit(e);
              if (!error) setTimeout(() => setShowComingSoon(false), 2000);
            }}>
              <input
                type="email"
                placeholder="Enter Email Address"
                ...
                onChange={(e) => setEmail(e.target.value)}
                required
                className="w-full px-4 py-3 border border-gray-200 rounded-xl mb-3 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-gray-900 placeholder-gray-500"
              />
              <button 
                type="submit"
                disabled={loading}
                className="bg-primary text-white px-6 py-3 rounded-xl font-medium hover:bg-orange-600 transition-colors w-full disabled:opacity-50"
              >
            ...
            {submitted && !error && (
              <div className="mt-4 animate-reveal">
                <p className="text-green-600 text-sm mb-3">Thanks! We'll notify you.</p>
                <a 
                  href="https://chat.whatsapp.com/DnWyjWmrh5jGKJY9K949pW" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-[#25D366] text-white px-4 py-2 rounded-xl text-sm font-bold hover:bg-[#128C7E] transition-colors w-full justify-center"
                >
            ...
            {error && (
              <p className="text-red-600 text-sm mt-3 animate-reveal">{error}</p>
            )}
          </div>
        </div>
      )}
